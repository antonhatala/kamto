...
jen `paid_date`/`skipped_at`; stav se vždy počítá. Služba „Kdykoliv v měsíci" nikdy nedá
*po splatnosti* (viz „Kdykoliv v měsíci" níže) — bez paid/skipped je vždy *naplánováno*.
_Avoid_: status sloupec, flag

**Kdykoliv v měsíci** (dříve „klouzavá"; kódový identifikátor zůstává `service.is_sliding`):
...
UI: checkbox „Platím kdykoliv v měsíci" ve formuláři služby, badge „Kdykoliv" v přehledech.
_Avoid_: klouzavá služba, pohyblivá služba, flexibilní splatnost
